...
Everything about TermJot is meant to place an emphasis on speed and convenience, and not interupting your workflow. At the end of the day, I wanted to make a tool that I would actually use myself, that I would pick over any other existing alternatives. I chose a tool that would be accessed from the terminal since that is a common tool available in almost any development environment. I have traditionally used neovim, and more recently I have been flirting with [Zed](https://zed.dev) due to its built in vim-mode and support for remappable keybindings. Even before both neovim and Zed, I used VSCode, and all 3 of those editors have quick terminal access (with Zed being the most readily available/convenient for me).
